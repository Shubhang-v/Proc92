...
function send()
{
    number1 = document.getElementById("num1_inp").value;
    number2 = document.getElementById("num2_inp").value;
    ...
    document.getElementById("num1_inp").value = "";
    document.getElementById("num2_inp").value = "";
